    ...
    return (
        <div className="h-[500px]">
            ...
            <div className="absolute w-full h-[1000px]" style={{ ...style }}>
                <Image src="/gallery/Sunnyside_World_ExampleScene.png" alt="" className="translate-y-1/4 sm:translate-y-0" fill unoptimized={true} objectFit="cover" />
            </div>
            <div className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 z-10 w-full">
                ...
                >
                    ...
                    <div className="max-w-[500px]">
                        <img src="logo_large_color_dark.svg" alt="" />
                    </div>
                </div>
            </div>
        </div>
